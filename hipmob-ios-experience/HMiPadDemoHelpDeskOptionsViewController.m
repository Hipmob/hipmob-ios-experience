...
#import "HMiPadDemoHelpDeskOptionsViewController.h"

@interface HMiPadDemoHelpDeskOptionsViewController ()
@property (nonatomic, strong) NSMutableArray *menuItems;
@end

@implementation HMiPadDemoHelpDeskOptionsViewController
