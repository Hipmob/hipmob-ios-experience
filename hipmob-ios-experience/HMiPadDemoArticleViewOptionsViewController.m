...
#import "HMiPadDemoArticleViewOptionsViewController.h"

@interface HMiPadDemoArticleViewOptionsViewController ()
@property (nonatomic, strong) NSMutableArray *menuItems;
@end

@implementation HMiPadDemoArticleViewOptionsViewController
