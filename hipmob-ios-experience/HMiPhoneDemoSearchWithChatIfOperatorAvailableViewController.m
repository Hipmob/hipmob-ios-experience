...
#import "HMiPhoneDemoSearchWithChatIfOperatorAvailableViewController.h"
#import "HMiPhoneConfig.h"
#import "hipmob/HMService.h"

@interface HMiPhoneDemoSearchWithChatIfOperatorAvailableViewController ()

@end

@implementation HMiPhoneDemoSearchWithChatIfOperatorAvailableViewController
...
- (IBAction)on_open_demo:(id)sender {
    ...
    [[HMService sharedService] openHelpdeskSearch:self withSetup:^(HMHelpDeskSearchViewController * controller){
        ...
        controller.chatEnabled = HMHelpDeskSearchChatEnabledIfOperatorAvailable;
